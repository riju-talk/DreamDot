...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\code\\DreamDot\\src\\lib\\generated\\client-audit",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "NEXT_PUBLIC_DIRECT_URL_AUDIT",
        "value": null
      }
    }
  },
  ...
  "inlineSchemaHash": "3da81dc764778519621f03596b6affc2edd035319b1da3613d55ca9219a4c949",
  "copyEngine": true
}
config.dirname = '/'
...
config.injectableEdgeEnv = () => ({
  parsed: {
    NEXT_PUBLIC_DIRECT_URL_AUDIT: typeof globalThis !== 'undefined' && globalThis['NEXT_PUBLIC_DIRECT_URL_AUDIT'] || typeof process !== 'undefined' && process.env && process.env.NEXT_PUBLIC_DIRECT_URL_AUDIT || undefined
  }
})
