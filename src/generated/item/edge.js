...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\code\\DreamDot\\src\\generated\\item",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "sourceFilePath": "E:\\code\\DreamDot\\src\\lib\\prisma\\schema.item.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
...
config.injectableEdgeEnv = () => ({
  parsed: {
    POSTGRESS_DB_ITEMS: typeof globalThis !== 'undefined' && globalThis['POSTGRESS_DB_ITEMS'] || typeof process !== 'undefined' && process.env && process.env.POSTGRESS_DB_ITEMS || undefined
  }
})
