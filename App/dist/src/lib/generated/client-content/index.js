...
const config = {
    "generator": {
        ...
        "output": {
            "value": "/home/iiitd/Desktop/fcs02/DreamDot/App/src/lib/generated/client-content",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "sourceFilePath": "/home/iiitd/Desktop/fcs02/DreamDot/App/src/lib/prisma/schema.content.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchemaHash": "638873e51d1ed36c4a976524395fbdfa1b2a1a0ab806c5121a9efd384a81a748",
    "copyEngine": true
};
const fs = require('fs');
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
    const alternativePaths = [
        "src/lib/generated/client-content",
        "lib/generated/client-content",
    ];
...
path.join(process.cwd(), "src/lib/generated/client-content/libquery_engine-debian-openssl-3.0.x.so.node");
// file annotations for bundling tools to include these files
path.join(__dirname, "query_engine-windows.dll.node");
path.join(process.cwd(), "src/lib/generated/client-content/query_engine-windows.dll.node");
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/lib/generated/client-content/schema.prisma");
