...
var uo = "This request could not be understood by the server", St = class extends $ {
    ...
    code = "P5000";
    constructor(r, t, n) { super(t || uo, R(r, !1)), n && (this.code = n); }
};
...
var mo = "Unknown server error", Br = class extends $ {
    ...
    code = "P5006";
    logs;
    constructor(r, t, n) { super(t || mo, R(r, !0)), this.logs = n; }
};
x(Br, "ServerError");
...
var go = "Usage exceeded, retry again later", Nt = class extends $ {
    ...
    code = "P5008";
    constructor(r, t = go) { super(t, R(r, !0)); }
};
...
function gu(e) {
    class r {
        ...
        constructor(n) { e = n?.__internal?.configOverride?.(e) ?? e, cl(e), n && lu(n, e); let i = new mu.EventEmitter().on("error", () => { }); this._extensions = Nr.empty(), this._previewFeatures = Wn(e), this._clientVersion = e.clientVersion ?? tu, this._activeProvider = e.activeProvider, this._globalOmit = n?.omit, this._tracingHelper = Hl(); let o = e.relativeEnvPaths && { rootEnvPath: e.relativeEnvPaths.rootEnvPath && Zn.default.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath), schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && Zn.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath) }, s; if (n?.adapter) {
            s = n.adapter;
