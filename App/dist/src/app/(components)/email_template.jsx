...
export const EmailTemplate = ({ firstName, OTP, }) => (<div style={{
        fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif",
        backgroundColor: "#f4f4f4",
        padding: "20px",
        margin: "0",
    }}>
        <table width="100%" cellPadding="0" cellSpacing="0" style={{ margin: "0 auto", maxWidth: "600px" }}>
            <tr>
                <td align="center">
...
//# sourceMappingURL=email_template.jsx.map