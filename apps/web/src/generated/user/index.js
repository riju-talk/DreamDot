...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Code\\01_full_stack\\DreamDot\\apps\\web\\src\\generated\\user",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Code\\01_full_stack\\DreamDot\\apps\\web\\src\\lib\\prisma\\schema.user.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
...
path.join(process.cwd(), "src/generated/user/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
