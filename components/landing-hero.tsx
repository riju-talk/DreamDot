...
export function LandingHero({ videoUrls }: { videoUrls: string[] }) {
  ...
  return (
    <div className="relative min-h-screen bg-[#0A0D13] text-white overflow-hidden flex items-stretch">
      {/* Video Background */}
      {randomVideoUrl && (
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#0A0D13]/20 to-[#0A0D13]/50"></div>
        </div>
      )}

      <div className="container mx-auto px-4 py-10 relative z-10 flex flex-row items-center justify-between w-full h-full">
        {/* Hero Section */}
        <div className="flex-1 text-center max-w-xl mx-4">
        ...
        <div className="flex-1 bg-[#0D1117] rounded-xl p-6 md:p-8 flex items-center justify-center max-w-xl mx-4">
          <div className="text-center md:text-left">
            ...
            <Button
              size="lg"
              className="bg-blue-400 text-black hover:bg-blue-400/90 mt-6 text-lg px-8"
