      ...
      <div className="relative z-10">
        <div className="text-center space-y-6">
          <div className="flex items-center justify-center gap-2">
            ...
            <h1 className="text-4xl font-bold text-primary">Digital Marketplace</h1>
            <Star className="h-8 w-8 text-secondary animate-pulse-soft" />
          </div>

          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Discover and purchase high-quality digital products from talented creators worldwide
          </p>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <Input
                type="search"
                placeholder="Search products, courses, or digital assets..."
